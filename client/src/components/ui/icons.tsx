...
export function HandshakeIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M9 11l3 3L8 23" />
      <path d="M9 11l-5 5v-4a2 2 0 0 1 2-2h3z" />
      <path d="M13 11l5-5h4v4l-5 5" />
      <path d="M14 6l1-1" />
      <path d="M9 11l-3-3" />
      <path d="M12 14l-3-3" />
    </svg>
...
export function ToyIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
